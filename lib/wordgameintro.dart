...
//                            SizedBox(height: 10.0,),
                            Center(child: Image(image: AssetImage('images/detectivegif-clipart-1.gif'), height: 300.0,)),
                            Padding(
                              padding: const EdgeInsets.all(20.0),
                              child: Text('Try to guess the right word usinig the picture and hint without running out of lives.', style: TextStyle(fontSize: 25.0, color: Colors.white, fontWeight: FontWeight.bold),),
                            )
                          ],
                        ),
                      ),
